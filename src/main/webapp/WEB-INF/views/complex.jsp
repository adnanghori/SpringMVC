...
<html>
  ...
  <body>
    <div class="main-block">
      ...
      <form action="complexformhandle" method="post">
        <div class="title">
        ...
        <div class="info">
          <input class="fname" type="text" name="name" placeholder="Full name">
           <input class="fname" type="text" name="id" placeholder="Student Id">
          ...
          <select name="courses">
           ...
           <input class="fname" type="text" name="address.city" placeholder="City">
